...
void  game_PlayerState::setName( LPCSTR n )
{
	xr_strcpy(name, n);
}
...
{
	EGameIDs gameID = IGame_Persistent::ParseStringToGameType(game_type_name);
	switch(gameID)
	{
