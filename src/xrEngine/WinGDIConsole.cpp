...
void CWinGDIConsole::CreateConsoleWnd()
{
	HINSTANCE hInstance = (HINSTANCE)GetModuleHandle(0);
	//----------------------------------
	RECT cRc;
	GetClientRect(Device.m_hWnd, &cRc);
	...
	WNDCLASS wndClass = { 0, WinGDIConsole_WndProc, 0, 0, hInstance,
		NULL,
	...
	m_hConsoleWnd = CreateWindow( wndclass, "XRAY Text Console", dwWindowStyle,
		lX, lY,
		lWidth, lHeight, Device.m_hWnd,
		0, hInstance, 0L );
	////---------------------------------------------------------------------------
	//m_hConsoleWnd = CreateWindowEx( WS_EX_TOPMOST, 
	//						wndclass, "S.T.A.L.K.E.R.: Call of Pripyat", WS_BORDER | WS_DLGFRAME,
...
void CWinGDIConsole::CreateLogWnd()
{
	HINSTANCE hInstance = (HINSTANCE)GetModuleHandle(0);
	//----------------------------------
	RECT cRc;
	...
	// Register the windows class
	WNDCLASS wndClass = { 0, WinGDIConsole_LogWndProc, 0, 0, hInstance,
		NULL,
...
void CWinGDIConsole::Initialize()
{
...
void CWinGDIConsole::DrawLog( HDC hDC, RECT* pRect )
{
	TEXTMETRIC tm;
