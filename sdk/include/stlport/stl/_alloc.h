...
protected:
  ...
  _Tp* _M_allocate(size_type __n, size_type& __allocated_n) {
    ...
    if (__n != 0) {
      size_type __buf_size = __n * sizeof(value_type);
#if !defined(XRAY_DISABLE_NEW_OPERATOR) || !defined(NDEBUG)
	  _Tp* __ret = 
#endif // #if !defined(XRAY_DISABLE_NEW_OPERATOR) || !defined(NDEBUG)
      ...
      return __ret;
#else // #if !defined(XRAY_DISABLE_NEW_OPERATOR) || !defined(NDEBUG)
      return 0;
#endif // #if !defined(XRAY_DISABLE_NEW_OPERATOR) || !defined(NDEBUG)
    }
