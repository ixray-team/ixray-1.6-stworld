...
#  if !defined(SN_TARGET_PS3) && !defined (__WATCOMC__) && (!defined (_STLP_MSVC_LIB) || (_STLP_MSVC_LIB < 1310) || defined(UNDER_CE))
...
#  if !defined(SN_TARGET_PS3) && !defined (__WATCOMC__) && (!defined (_STLP_MSVC_LIB) || (_STLP_MSVC_LIB < 1400) || defined (_STLP_USING_PLATFORM_SDK_COMPILER) || defined(UNDER_CE))
