 ...
 */
#  if defined (_STLP_NO_IOSTREAMS) && !defined(_FORCE_IOSTREAM_BUILD)
...
#  if defined (_MIPSEB) || defined (__sparc) || defined (_AIX) || \
      defined (__hpux) || defined (macintosh) || defined (_MAC) || defined(SN_TARGET_PS3)
...
#  if defined (_STLP_USE_NAMESPACES) && (defined(_STLP_USE_OWN_NAMESPACE) || defined (_STLP_VENDOR_GLOBAL_CSTD)) //&& !defined(SN_TARGET_PS3)
